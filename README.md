...
- Основной текстовый канал «**chat**» предназначен для вопросов по Laravel и всех других вопросов, связанных с разработкой сайтов.
- Для оффтопа и «просто поболтать» есть [«**offtop**»](https://discord.gg/c8gJfed)
- Голосовой канал «**Прихожая**» предназначен для общения голосом и никаких ограничений не накладывает.
- Язык общения — русский, транслит не желателен.
- Запрещено спамить и оскорблять других участников.
- В основном канале («**chat**») не стоит флудить (вы будете мешать) и материться (потому что мы культурные).
...
- В чате не допускается распространеение информации, запрещённой законодательством стран СНГ (например, распространение пиратского ПО). Переходите в личку и делайте там что угодно ;)
- Запрещено обсуждение разработки сайтов, запрещённых законодательством стран СНГ, а также (в том числе) порнографического содержания, интернет-казино и онлайн-рулеток.
